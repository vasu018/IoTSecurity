...
def createstruct(filename):
    with open(filename,'r') as f:
        ...
        with open('policies1/user3.conf','w') as f2:
            f2.write(flattendir(abstraction))
#         print(abstraction)
        
        
createstruct('abstractions/abs2.json')
