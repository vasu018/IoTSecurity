...
#policies = ['1k', '2k', '3k', '4k', '5k', '6k', '7k', '8k', '9k', '10k', '11k', '12k', '13k', '14k', '15k', '16k']
...
plt.ylabel('Latency (sec)', fontsize=18)
plt.ylim([0,200])
plt.grid(True)
plt.legend(loc = 'best', fontsize = 18)
plt.savefig("../Results/composition-latency.pdf", bbox_inches='tight')
plt.show()
